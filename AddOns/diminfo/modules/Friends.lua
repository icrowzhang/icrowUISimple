...
if cfg.Friends == true then
	...
	local function Update(self, event, ...)
		...
		Text:SetText(format(cfg.ColorClass and init.Colored.."%d|r%s" or "%d%s",onlineFriends + numBNetOnline,"friends"))
		...
		if #BNTable > 0 then
			...
			for i = 1, #BNTable do
				...
				if (info[8]) then
					...
					if info[7] == wowString and info[12] == myrealm and playerFaction == info[13] then
