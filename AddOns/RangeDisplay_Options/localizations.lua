...
L["Show max-min instead of min-max"] = "최대-분 대신 분-최대로 보기"
...
L["Color"] = "顏色"
L["Copy section settings to other units"] = "複製這段的設定到其他單位" -- Needs review
...
L["Play a sound when entering this range"] = "當進入範圍時播放聲音" -- Needs review
L["Range limit"] = "距離限制"
...
L["The text to display for this section"] = "顯示此項的文字" -- Needs review
L["The text to display when you are further than range limit"] = "顯示當你超過距離限制的文字" -- Needs review
...
L["Use section colors for background and background color for text"] = "使用這項的顏色當作背景與背景文本的顏色" -- Needs review
L["Use warning sound for enemy targets only"] = "只在敵對目標使用警告聲" -- Needs review
